@echo off
rem Build MirrorLAN.exe from main.py (one file, GUI, no console window).
...
python -m PyInstaller --noconfirm --clean --onefile --windowed --name MirrorLAN --icon app.ico --add-data "www;www" main.py
if errorlevel 1 (
